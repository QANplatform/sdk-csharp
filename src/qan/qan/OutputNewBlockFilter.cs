...
namespace qan.qan
{
    ...
    /// </summary>
    [DataContract(Name = "Output_newBlockFilter")]
    public partial class OutputNewBlockFilter : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OutputNewBlockFilter" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OutputNewBlockFilter() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OutputNewBlockFilter" /> class.
        /// </summary>
        /// <param name="filterId">A filter id to be used when calling getFilterChanges (required).</param>
        public OutputNewBlockFilter(string filterId = default(string))
        {
            // to ensure "filterId" is required (not null)
            if (filterId == null)
            {
                throw new ArgumentNullException("filterId is a required property for OutputNewBlockFilter and cannot be null");
            }
